...
public class CompanyAuditRoleRelationship extends BaseModelBean{
	public String getFullClassName() {
		return "com.doublechain.storedev.companyauditrolerelationship.CompanyAuditRoleRelationship";
	}
	// 枚举对象
