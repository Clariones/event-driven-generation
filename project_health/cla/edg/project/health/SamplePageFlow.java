...
public class SamplePageFlow extends BasePageFlowDescriptionScript {
...
//					.may_request("view my shop")
			...
			.request("cancel ink deed order").with_string("order id")
				...
				.got_popup_page().comments("只包含一个popup的页面")
			...
			.request("view my ink deed info").with_string("artwork auction id")
				...
				.got_page("ink deed detail by holder and price").comments("按持有人和价格查看")
...
//			
	...
	public PageFlowScript getScript() {
		return SCRIPT.import_from(new SamplePageFlowPiece())
				;
	}
