...
public class PaymentStatus extends BaseModelBean{
	...
	// 枚举对象
	public static EnumAttribute NEED_PAY = new EnumAttribute("com.terapico.moyi.paymentstatus.PaymentStatus", "NEED_PAY");
	public static EnumAttribute PROCESSING = new EnumAttribute("com.terapico.moyi.paymentstatus.PaymentStatus", "PROCESSING");
	public static EnumAttribute PAID = new EnumAttribute("com.terapico.moyi.paymentstatus.PaymentStatus", "PAID");
	public static EnumAttribute CANCELLED = new EnumAttribute("com.terapico.moyi.paymentstatus.PaymentStatus", "CANCELLED");
