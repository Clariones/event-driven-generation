...
public class Main {
	private static String OUTPUT_FOLDER = "/works/jobs/optical_v1/workspace/optical-biz-suite/bizcore/WEB-INF/optical_client_src";
...
//		testV3EventService(new V3AuctionService());
    ...
    private static void testChagneRequest(Map<String, Map<String, Object>> script) throws Exception  {
        ...
        String crXmlOutputFolder = "/works/jobs/optical_v1/workspace/web-code-generator/sky";
