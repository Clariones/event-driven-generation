...
public class ClipOnType extends BaseModelBean{
	...
	// 枚举对象
	public static EnumAttribute MAG_CLIP_ON = new EnumAttribute("com.doublechaintech.optical.clipontype.ClipOnType", "MAG_CLIP_ON");
	public static EnumAttribute NORMAL_CLIP_ON = new EnumAttribute("com.doublechaintech.optical.clipontype.ClipOnType", "NORMAL_CLIP_ON");
