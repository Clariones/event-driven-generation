...
public class LensMaterialType extends BaseModelBean{
	...
	// 枚举对象
	public static EnumAttribute PLASTIC = new EnumAttribute("com.doublechaintech.optical.lensmaterialtype.LensMaterialType", "PLASTIC");
	public static EnumAttribute GLASSES = new EnumAttribute("com.doublechaintech.optical.lensmaterialtype.LensMaterialType", "GLASSES");
