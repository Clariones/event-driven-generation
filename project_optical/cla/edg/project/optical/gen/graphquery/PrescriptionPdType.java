...
public class PrescriptionPdType extends BaseModelBean{
	...
	// 枚举对象
	public static EnumAttribute SINGLE_PD = new EnumAttribute("com.doublechaintech.optical.prescriptionpdtype.PrescriptionPdType", "SINGLE_PD");
	public static EnumAttribute DUAL_PD = new EnumAttribute("com.doublechaintech.optical.prescriptionpdtype.PrescriptionPdType", "DUAL_PD");
