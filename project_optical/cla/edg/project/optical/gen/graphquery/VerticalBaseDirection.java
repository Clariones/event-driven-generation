...
public class VerticalBaseDirection extends BaseModelBean{
	...
	// 枚举对象
	public static EnumAttribute UP = new EnumAttribute("com.doublechaintech.optical.verticalbasedirection.VerticalBaseDirection", "UP");
	public static EnumAttribute DOWN = new EnumAttribute("com.doublechaintech.optical.verticalbasedirection.VerticalBaseDirection", "DOWN");
