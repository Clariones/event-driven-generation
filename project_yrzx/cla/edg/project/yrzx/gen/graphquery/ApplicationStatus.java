...
public class ApplicationStatus extends BaseModelBean {
  ...
  // 枚举对象
  public static EnumAttribute POSTED =
      new EnumAttribute("com.yrdec.yrzx.applicationstatus.ApplicationStatus", "POSTED");
  public static EnumAttribute PROCESSING =
      new EnumAttribute("com.yrdec.yrzx.applicationstatus.ApplicationStatus", "PROCESSING");
  public static EnumAttribute FINISHED =
      new EnumAttribute("com.yrdec.yrzx.applicationstatus.ApplicationStatus", "FINISHED");
  public static EnumAttribute CANCELLED =
      new EnumAttribute("com.yrdec.yrzx.applicationstatus.ApplicationStatus", "CANCELLED");
