...
public class AuthenticateStatus extends BaseModelBean{
	...
	// 枚举对象
	public static EnumAttribute AUTHENTICATED = new EnumAttribute("com.yrdec.yrzx.authenticatestatus.AuthenticateStatus", "AUTHENTICATED");
	public static EnumAttribute PENDING = new EnumAttribute("com.yrdec.yrzx.authenticatestatus.AuthenticateStatus", "PENDING");
