...
public class BrandPartnerSettlement extends BaseModelBean {
  public String getFullClassName() {
    return "com.yrdec.yrzx.brandpartnersettlement.BrandPartnerSettlement";
  }
  // 枚举对象
  ...
  public DateTimeAttribute settlementDate() {
    ...
    member.setName("settlement_date");
    useMember(member);
    return member;
  }
