...
public class ChangeRequest extends BaseModelBean {
  ...
  public EventPledgedContractInfo eventPledgedContractInfoList() {
    EventPledgedContractInfo member = new EventPledgedContractInfo();
    member.setModelTypeName("event_pledged_contract_info");
    member.setName("change_request");
    member.setMemberName("eventPledgedContractInfoList");
    member.setRelationName("changeRequest");
    member.setReferDirection(false);
    append(member);
    return member;
