...
public class EventExpectedPayItemComments extends BaseModelBean {
  public String getFullClassName() {
    return "com.yrdec.yrzx.eventexpectedpayitemcomments.EventExpectedPayItemComments";
  }
  // 枚举对象
  ...
  public StringAttribute sendTo() {
    StringAttribute member = new StringAttribute();
    member.setModelTypeName("string_longtext");
    // member.setName("sendTo");
    member.setName("send_to");
    useMember(member);
    return member;
  }

  public StringAttribute ccTo() {
    StringAttribute member = new StringAttribute();
    member.setModelTypeName("string_longtext");
    // member.setName("ccTo");
