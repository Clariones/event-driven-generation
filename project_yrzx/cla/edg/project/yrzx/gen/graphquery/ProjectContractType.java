...
public class ProjectContractType extends BaseModelBean{
	public String getFullClassName() {
		return "com.yrdec.yrzx.projectcontracttype.ProjectContractType";
	}
	// 枚举对象
	...
	public BooleanAttribute platformLevelContract(){
		BooleanAttribute member = new BooleanAttribute();
		member.setModelTypeName("bool");
		member.setName("platformLevelContract");
		useMember(member);
		return member;
	}
