...
public class ProjectSubcontractAssignmentType extends BaseModelBean{
	public String getFullClassName() {
		return "com.yrdec.yrzx.projectsubcontractassignmenttype.ProjectSubcontractAssignmentType";
	}
	// 枚举对象
