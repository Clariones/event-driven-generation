...
public class TaskStatus extends BaseModelBean {
  ...
  public static EnumAttribute PENDING =
      new EnumAttribute("com.yrdec.yrzx.taskstatus.TaskStatus", "PENDING");
  public static EnumAttribute PROCESSING =
      new EnumAttribute("com.yrdec.yrzx.taskstatus.TaskStatus", "PROCESSING");
  public static EnumAttribute READY_FOR_ACCEPTANCE =
      new EnumAttribute("com.yrdec.yrzx.taskstatus.TaskStatus", "READY_FOR_ACCEPTANCE");
  public static EnumAttribute COMPLETED =
      new EnumAttribute("com.yrdec.yrzx.taskstatus.TaskStatus", "COMPLETED");
