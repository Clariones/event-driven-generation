...
public class WorkPackageParticipatorContract extends BaseModelBean{
	public String getFullClassName() {
		return "com.yrdec.yrzx.workpackageparticipatorcontract.WorkPackageParticipatorContract";
	}
	// 枚举对象
