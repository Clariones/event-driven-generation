...
public class CertificateStatus extends BaseModelBean {
  ...
  // 枚举对象
  public static EnumAttribute NEED_CERTIFICATE =
      new EnumAttribute(
          "com.terapico.moyi.certificatestatus.CertificateStatus", "NEED_CERTIFICATE");
  public static EnumAttribute PROCESSING =
      new EnumAttribute("com.terapico.moyi.certificatestatus.CertificateStatus", "PROCESSING");
  public static EnumAttribute CERTIFICATED =
      new EnumAttribute("com.terapico.moyi.certificatestatus.CertificateStatus", "CERTIFICATED");
  public static EnumAttribute FAILED =
      new EnumAttribute("com.terapico.moyi.certificatestatus.CertificateStatus", "FAILED");
  public static EnumAttribute ABATE =
      new EnumAttribute("com.terapico.moyi.certificatestatus.CertificateStatus", "ABATE");
