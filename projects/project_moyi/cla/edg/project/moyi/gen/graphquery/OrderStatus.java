...
public class OrderStatus extends BaseModelBean {
  ...
  public static EnumAttribute NEED_PAY =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "NEED_PAY");
  public static EnumAttribute PAYING =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "PAYING");
  public static EnumAttribute NEED_DELIVER =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "NEED_DELIVER");
  public static EnumAttribute NEED_CONFIRM =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "NEED_CONFIRM");
  public static EnumAttribute CLOSED =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "CLOSED");
  public static EnumAttribute PENDING_ARBITRATION =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "PENDING_ARBITRATION");
  public static EnumAttribute CANCELLED =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "CANCELLED");
  public static EnumAttribute BUYER_DEFAULT =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "BUYER_DEFAULT");
  public static EnumAttribute SELLER_DEFAULT =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "SELLER_DEFAULT");
  public static EnumAttribute SEVEN_DAY_WARRANTY =
      new EnumAttribute("com.terapico.moyi.orderstatus.OrderStatus", "SEVEN_DAY_WARRANTY");
