...
public class HorizontalBaseDirection extends BaseModelBean {
  ...
  // 枚举对象
  public static EnumAttribute IN =
      new EnumAttribute(
          "com.doublechaintech.optical.horizontalbasedirection.HorizontalBaseDirection", "IN");
  public static EnumAttribute OUT =
      new EnumAttribute(
          "com.doublechaintech.optical.horizontalbasedirection.HorizontalBaseDirection", "OUT");
