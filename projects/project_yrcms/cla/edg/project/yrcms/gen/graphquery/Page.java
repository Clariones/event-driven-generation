...
public class Page extends BaseModelBean {
  public String getFullClassName() {
    return "com.yrdec.yrcms.page.Page";
  }
  // 枚举对象
  public static EnumAttribute WXAPP_HOMEPAGE =
      new EnumAttribute("com.yrdec.yrcms.page.Page", "WXAPP_HOMEPAGE");
  public static EnumAttribute GOLDEN_SERVICE =
      new EnumAttribute("com.yrdec.yrcms.page.Page", "GOLDEN_SERVICE");
  public static EnumAttribute DESIGNER = new EnumAttribute("com.yrdec.yrcms.page.Page", "DESIGNER");
  public static EnumAttribute ORGNIZATION =
      new EnumAttribute("com.yrdec.yrcms.page.Page", "ORGNIZATION");
  public static EnumAttribute ASSOCIATION =
      new EnumAttribute("com.yrdec.yrcms.page.Page", "ASSOCIATION");
  public static EnumAttribute BIZ_CHAIN =
      new EnumAttribute("com.yrdec.yrcms.page.Page", "BIZ_CHAIN");
  public static EnumAttribute REAL_ESTATE =
      new EnumAttribute("com.yrdec.yrcms.page.Page", "REAL_ESTATE");
  public static EnumAttribute JGDT = new EnumAttribute("com.yrdec.yrcms.page.Page", "JGDT");
  public static EnumAttribute YZPP = new EnumAttribute("com.yrdec.yrcms.page.Page", "YZPP");
  public static EnumAttribute BIM = new EnumAttribute("com.yrdec.yrcms.page.Page", "BIM");
