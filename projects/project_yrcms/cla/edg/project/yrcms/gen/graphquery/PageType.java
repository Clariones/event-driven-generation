...
public class PageType extends BaseModelBean {
  public String getFullClassName() {
    return "com.yrdec.yrcms.pagetype.PageType";
  }
  // 枚举对象
  public static EnumAttribute HOME = new EnumAttribute("com.yrdec.yrcms.pagetype.PageType", "HOME");
  public static EnumAttribute ME = new EnumAttribute("com.yrdec.yrcms.pagetype.PageType", "ME");
  public static EnumAttribute GENERIC_PAGE =
      new EnumAttribute("com.yrdec.yrcms.pagetype.PageType", "GENERIC_PAGE");
  public static EnumAttribute LISTOF_PAGE =
      new EnumAttribute("com.yrdec.yrcms.pagetype.PageType", "LISTOF_PAGE");
  public static EnumAttribute SERVICE_CENTER =
      new EnumAttribute("com.yrdec.yrcms.pagetype.PageType", "SERVICE_CENTER");
  public static EnumAttribute SIMPLE =
      new EnumAttribute("com.yrdec.yrcms.pagetype.PageType", "SIMPLE");
