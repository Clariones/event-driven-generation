...
public class EngineeringQualitySupervisionArchive extends BaseModelBean{
	public String getFullClassName() {
		return "com.yrdec.yrzx.engineeringqualitysupervisionarchive.EngineeringQualitySupervisionArchive";
	}
	// 枚举对象
