...
public class S3_ProjectForPropertyOwner extends PieceOfScript{
	...
	public PageFlowScript makeSequel(PageFlowScript script) {
		PageFlowScript rst = script
			...
			.request("open document confirmation form for property owner").with_string("document id").with_string("mission id")
...
//					.comments("确认/同意文档内容的表单")
			.request("confirm document as owner").with_string("document id").with_string("mission id").with_string("verify code")
				.comments("确认项目中某个文档").need_login().no_footprint()
				.got_page("project attachment for property owner")
			.request("reject document as owner").with_string("document id").with_string("mission id").with_string("verify code")
				.comments("否决项目中某个文档").need_login().no_footprint()
				.got_page("project attachment for property owner")
